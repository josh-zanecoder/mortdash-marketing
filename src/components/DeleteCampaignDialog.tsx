    ...
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      <DialogContent className="max-w-md w-[95vw] p-0 rounded-2xl mx-auto">
        <DialogHeader className="flex flex-col items-center justify-center pt-8 pb-2">
          ...
          <DialogTitle className="text-2xl font-bold text-gray-900">Delete Campaign</DialogTitle>
        </DialogHeader>
        <div className="px-8 pb-8 text-center">
          <p className="mb-6 text-base text-gray-700">
            Are you sure you want to delete <span className="font-semibold text-gray-900">"{campaignName}"</span>?
