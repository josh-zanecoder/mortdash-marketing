    ...
    <div className="min-h-screen flex flex-col bg-[#fafafa]">
      <div className="w-full max-w-7xl mx-auto mt-12 mb-12">
        <div className="shadow-sm border rounded-xl bg-white p-8 sm:p-14" style={{ minHeight: "700px" }}>
          <CardHeader>
            <CardTitle className="text-4xl font-extrabold tracking-tight">Tracking</CardTitle>
            <CardDescription className="mt-2 text-lg">Track campaign performance and analytics.</CardDescription>
          </CardHeader>
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <div className="relative">
                  <input
                    ...
                    value={date}
                    readOnly
                    className="border rounded-md px-3 py-2 text-sm w-32 bg-white cursor-pointer"
                  />
