...
import { Archive, Eye, X, Plus, Search, ChevronDown, Edit } from 'lucide-react';
...
function CampaignPageContent() {
  ...
  const { templates, loading: templatesLoading, fetchTemplates, clearTemplates, updateTemplate } = useCampaignStore();
