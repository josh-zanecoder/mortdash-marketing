                  ...
                  <div key={sheet.id} className="bg-[#fdf6f1] rounded-lg p-4 border border-[#ffe3d1] hover:bg-[#fff7ed] transition-colors">
                    ...
                    {sheet.blob ? (
                      <button 
                        ...
                        className="cursor-pointer w-full bg-[#ff6600] hover:bg-[#e65c00] text-white text-sm font-medium py-2 px-4 rounded-lg transition-colors flex items-center justify-center gap-2"
                      >
